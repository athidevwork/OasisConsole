...
public class OasisConsoleResource {
	 ...
	 * LOGGER.debug("Setting app context"); this.applicationContext =
	 * applicationContext; }
	 */
	...
	@Path("/link")
	@Produces({ MediaType.TEXT_PLAIN })
	public String getLink(@QueryParam("env") String env, @QueryParam("product") String product) {
		return OasisConsoleUtil.getLinkFor(env, product);
	}
