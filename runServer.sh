...
java -cp build/libs/OasisConsole.jar -Dlog4j.debug -Dlog4j.configuration=log4j.properties -jar build/libs/OasisConsole.jar 20001 $@ 2>&1 | tee server_output.log
